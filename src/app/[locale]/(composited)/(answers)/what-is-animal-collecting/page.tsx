...
export default async function WhatIsAnimalCollectingPage({params}: {params: {locale: string}}) {
    return AnswerPage({slug: "what-is-animal-collecting", locale: params.locale});
}
