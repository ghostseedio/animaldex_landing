...
const wisdomPaths = [
    ...
    },
    {
        ...
        description: "Browse recurring survival strategies across species, from precision and observation to cooperation, memory, and adaptation.",
        href: "/principles",
        cta: "Explore behavioral principles",
        examples: [
            {label: "Precision", href: "/principles/precision"},
            {label: "Observation", href: "/principles/observation"}
        ]
    }
];
...
const faq = [
    {
        ...
        answer: "Animal Wisdom is AnimalDex's home for animal symbolism, lessons from real behavior, and recurring behavioral principles such as patience, timing, teamwork, focus, and adaptability."
    },
    {
    ...
    {
        question: "What is the difference between symbolism, lessons, and principles?",
        answer: "Symbolism explores cultural and interpretive meaning, lessons turn behavior into practical takeaways, and principles group animals by recurring strategies found in nature."
    },
    {
...
export default function AnimalWisdomPage({params}: AnimalWisdomPageProps) {
    ...
    const articleSchema = {
        ...
        about: [
            ...
            {"@type": "Thing", name: "Behavioral principles"}
        ]
    };
    const faqSchema = {
        "@context": "https://schema.org",
